...
-- Tabela: public.carrinhos (depende de clientes)
...
-- Tabela: public.enderecos (depende de clientes)
...
-- Tabela: public.listas_favoritos (depende de clientes)
...
-- Tabela: public.pedidos (depende de clientes, carrinhos, enderecos)
...
-- Tabela: public.categorias_produto (depende de produtos, categorias)
...
-- Tabela: public.ocasioes_produto (depende de produtos, ocasioes)
...
-- Tabela: public.itens_carrinho (depende de carrinhos, produtos)
...
-- Tabela: public.itens_lista_favoritos (depende de listas_favoritos, produtos)
...
-- Tabela: public.itens_pedido (depende de pedidos, produtos)
